...
namespace rummikubGame
{
    public partial class GameTable : Form
    {
        ...
        private void clearAllTilesFromScreen()
        {
            ...
            {
                GameTable.global_gametable_context.Controls.Remove(GameTable.dropped_tiles_stack.Peek().TileButton.GetButton());
        ...
        private void loadGameToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                GameTable.dropped_tiles_stack = (Stack<VisualTile>)formatter.Deserialize(stream);
